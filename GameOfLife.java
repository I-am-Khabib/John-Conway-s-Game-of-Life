...
public class GameOfLife {
    ...
    public  GameOfLife(GameZoom Z) {
        this.gridSize = Z.getGridSize();
        this.cellSize = Z.getCellSize();
    ...
    public void loadGameBoardFromDB(String grid) throws IOException {
        File mydbfile=new File("db.txt");
        loadGameBoardFromFile(mydbfile);
        setNeedsRedraw(true);
    }
